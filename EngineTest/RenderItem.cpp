...
namespace {
	...
	void load_shaders() {
		// for example, material uses a vertex shader and a pixel shader
...
void create_render_items() {
	// NOTE: It is possible to replace with any model that's avaiable.
	...
	// NOTE: we need shaders to be ready before creating material
	create_material();
