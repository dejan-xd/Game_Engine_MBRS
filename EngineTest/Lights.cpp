...
void test_lights(f32 dt) {
	...
	for (u32 i{ 0 }; i < count; ++i) {
		...
		create_light(p1, { random() * 3.14f, random() * 3.14f, random() * 3.14f }, random() > 0.5f ? graphics::light::spot : graphics::light::point, left_set);
		create_light(p2, { random() * 3.14f, random() * 3.14f, random() * 3.14f }, random() > 0.5f ? graphics::light::spot : graphics::light::point, right_set);
	}
