...
namespace primal::graphics::d3d12 {
	...
	public:
		...
		template<typename T> [[nodiscard]] T* const allocate() {
		...
		template<typename T> [[nodiscard]] constexpr D3D12_GPU_VIRTUAL_ADDRESS gpu_address(T* const allocation) {
	...
	public:
		...
		constexpr uav_clearable_buffer(uav_clearable_buffer&& o) : _buffer{ std::move(o._buffer) }, _uav{ o._uav }, _uav_shader_visible{ o._uav_shader_visible } {
			o.reset();
		}
