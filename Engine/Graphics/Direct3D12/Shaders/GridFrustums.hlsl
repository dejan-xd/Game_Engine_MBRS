...
// Implementation of grid frustums shader is based on "Forward vs Deferred vs Forward+ Rendering with DirectX 11" (2015) by Jeremiah van Oosten.
...
void ComputeGridFrustumsCS(uint3 DispatchThreadID : SV_DispatchThreadID)
{
    ...
    // Compute the 4 corner points of the far clipping plane to use as the frustum vertices.
