...
// This equation assumes a right-handed (counter-clockwise winding order) coordinate system to determine the direction of the plane normal.
// Swap v0 and v2 if you'd like to use a left-handed winding order.
