...
namespace primal::graphics::d3d12::content {
	...
	namespace submesh {
		...
		id::id_type add(const u8*& data) {
			...
			constexpr u32 aligment{ D3D12_STANDARD_MAXIMUM_ELEMENT_ALIGNMENT_BYTE_MULTIPLE };
			const u32 aligned_position_buffer_size{ (u32)math::align_size_up<aligment>(position_buffer_size) };
			const u32 aligned_element_buffer_size{ (u32)math::align_size_up<aligment>(element_buffer_size) };
