...
namespace Editor.GameProject.ViewModel
{
	...
	public class NewProject : ViewModelBase
	{
		...
		public string CreateProject(ProjectTemplate template)
		{
			...
			if (!IsValid)
			{
				Logger.Log(MessageType.Error, $"NewProject - CreateProject : Failed to create {ProjectName}.");
				return string.Empty;
			}
			...
			{
				Debug.WriteLine(ex);
				Logger.Log(MessageType.Error, $"NewProject - CreateProject : Failed to create {ProjectName}. {ex.Message}");
				return string.Empty;
			}
		}
		...
		public NewProject()
		{
			...
			{
				Debug.WriteLine(ex);
				Logger.Log(MessageType.Error, $"NewProject : Failed to read project templates. {ex.Message}");
				throw;
			}
		}
	}
